...
- The `/token` route auto-refreshes buy/sell quotes after a 650ms dwell on amount or slippage edits. Quote reads stay available without a connected wallet, but buy/sell submit buttons stay wallet-gated, open the shared wallet-request modal, and the trade adapters re-quote before sending.
