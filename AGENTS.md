...
- Frontend text validation should stay aligned with `bots/cheapbugs_broker/commands.py`: title 3-120 characters, public summary 10-2,000 characters, and private details 10-12,000 characters after trimming. `src/types/submission.ts` owns the frontend constants and validator.
