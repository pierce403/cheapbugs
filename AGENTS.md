...
- The `/bond` route must keep the large conduct warning from `src/views/stake.ts`: bonded users who demonstrate anti-social behavior, including spam, harassment, or criminal activity related to platform bugs, can have stake burned immediately into the treasury.
