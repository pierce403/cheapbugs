...
- **Properties**:
  ...
  - Home/index bug-listing tables show score, title, author, date, and unlock columns in that order. The score, date, and unlock columns are kept tight and fixed-width; the target column is intentionally omitted from this compact archive view so long titles get the widest column.
